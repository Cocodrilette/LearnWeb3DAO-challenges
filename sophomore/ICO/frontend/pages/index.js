...
export default function Home() {
  ...
  const getTokensToBeClaimed = async () => {
    try {
      ...
      if (balance === zero) {
        ...
        //convert amount to a big number and then set its value
   ...
   *
   * A `Signer` is a special type of Provider used in case a `write` transaction needs to
   * be made to the blockchain, which involves the connected account
